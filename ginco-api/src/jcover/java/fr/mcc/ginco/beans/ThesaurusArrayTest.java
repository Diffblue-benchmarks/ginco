...
class ThesaurusArrayTest {
	...
	void factory() throws java.text.ParseException {
		...
		ThesaurusArray parent3 = new ThesaurusArray();
		parent3.setConcepts(new HashSet<ThesaurusArrayConcept>());
		parent3.setIdentifier("data");
		parent3.setNotation("DE");
		parent3.setOrdered(false);
		parent3.setParent(new ThesaurusArray());
		parent3.setSuperOrdinateConcept(new ThesaurusConcept());
		...
		parent2.setSuperOrdinateConcept(superOrdinateConcept2);
		...
		parent2.setThesaurus(thesaurus3);
		...
		parent1.setSuperOrdinateConcept(superOrdinateConcept3);
		...
		parent1.setThesaurus(thesaurus5);
		thesaurusArray.setParent(parent1);
		ThesaurusConcept superOrdinateConcept4 = new ThesaurusConcept();
		superOrdinateConcept4.setAssociativeRelationshipLeft(new HashSet<AssociativeRelationship>());
		superOrdinateConcept4.setAssociativeRelationshipRight(new HashSet<AssociativeRelationship>());
		superOrdinateConcept4.setConceptArrays(new HashSet<ThesaurusArray>());
		superOrdinateConcept4.setCreated(new SimpleDateFormat("yyyy-MM-dd").parse("2010-12-31"));
		superOrdinateConcept4.setIdentifier("data");
		superOrdinateConcept4.setModified(new SimpleDateFormat("yyyy-MM-dd").parse("2010-12-31"));
		superOrdinateConcept4.setNotation("DE");
		superOrdinateConcept4.setParentConcepts(new HashSet<ThesaurusConcept>());
		superOrdinateConcept4.setRootConcepts(new HashSet<ThesaurusConcept>());
		superOrdinateConcept4.setStatus(1);
		...
		superOrdinateConcept4.setThesaurus(thesaurus6);
		superOrdinateConcept4.setTopConcept(false);
		...
		thesaurus7.setCreator(creator5);
		...
		assertThat(thesaurusArray.getParent(), sameInstance(parent1));
		assertThat(thesaurusArray.getSuperOrdinateConcept(), sameInstance(superOrdinateConcept4));
		assertThat(thesaurusArray.getThesaurus(), sameInstance(thesaurus7));
	}
}
