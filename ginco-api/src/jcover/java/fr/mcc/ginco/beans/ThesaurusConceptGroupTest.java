...
class ThesaurusConceptGroupTest {
	...
	void factory() throws java.text.ParseException {
		...
		ThesaurusConceptGroupType conceptGroupType3 =
			 new ThesaurusConceptGroupType();
		conceptGroupType3.setCode("DE");
		conceptGroupType3.setLabel("label");
		conceptGroupType3.setSkosLabel("label");
		parent2.setConceptGroupType(conceptGroupType3);
		...
		parent2.setParentConcept(parentConcept2);
		...
		parent1.setParentConcept(parentConcept3);
		...
		parentConcept4.setAssociativeRelationshipLeft(new HashSet<AssociativeRelationship>());
		parentConcept4.setAssociativeRelationshipRight(new HashSet<AssociativeRelationship>());
		parentConcept4.setConceptArrays(new HashSet<ThesaurusArray>());
		parentConcept4.setCreated(new SimpleDateFormat("yyyy-MM-dd").parse("2010-12-31"));
		parentConcept4.setIdentifier("data");
		parentConcept4.setModified(new SimpleDateFormat("yyyy-MM-dd").parse("2010-12-31"));
		parentConcept4.setNotation("DE");
		parentConcept4.setParentConcepts(new HashSet<ThesaurusConcept>());
		parentConcept4.setRootConcepts(new HashSet<ThesaurusConcept>());
		parentConcept4.setStatus(1);
		...
		parentConcept4.setThesaurus(thesaurus6);
		parentConcept4.setTopConcept(false);
		...
		assertThat(thesaurusConceptGroup.getParent(), sameInstance(parent1));
		assertThat(thesaurusConceptGroup.getParentConcept(), sameInstance(parentConcept4));
		assertThat(thesaurusConceptGroup.getThesaurus(), sameInstance(thesaurus7));
	}
}
