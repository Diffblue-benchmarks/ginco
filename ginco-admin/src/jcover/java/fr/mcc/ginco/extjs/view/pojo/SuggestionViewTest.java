...
class SuggestionViewTest {
	...
	void factory() {
		...
		suggestionView.setCreated("someone");
		suggestionView.setCreator("someone");
		...
		assertThat(suggestionView.getCreated(), is("someone"));
		assertThat(suggestionView.getCreator(), is("someone"));
