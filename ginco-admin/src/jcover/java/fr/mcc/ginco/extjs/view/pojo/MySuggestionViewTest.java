...
class MySuggestionViewTest {
	...
	void factory() {
		...
		view.setCreated("someone");
		view.setCreator("someone");
		...
		mySuggestionView.setCreated("someone");
		mySuggestionView.setCreator("someone");
		...
		assertThat(mySuggestionView.getCreated(), is("someone"));
		assertThat(mySuggestionView.getCreator(), is("someone"));
