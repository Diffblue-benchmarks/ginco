...
class ThesaurusVersionHistoryViewTest {
	...
	@Test
	void factory() {
		ThesaurusVersionHistoryView thesaurusVersionHistoryView = new ThesaurusVersionHistoryView();
		thesaurusVersionHistoryView.setDate("1999-12-31");
		thesaurusVersionHistoryView.setIdentifier("1.0");
		...
		assertThat(thesaurusVersionHistoryView.getIdentifier(), is("1.0"));
