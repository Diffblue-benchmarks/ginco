...
public class AssociativeRelationshipDAOTest {
	...
	@Test
	public void getAssociatedConceptsStatusIsCandidate() throws org.hibernate.HibernateException, org.hibernate.UnknownProfileException, javax.naming.NamingException {
		AssociativeRelationshipDAO associativeRelationshipDAO =
			 new AssociativeRelationshipDAO();
		...
		assertTrue(associativeRelationshipDAO.getAssociatedConcepts(new ThesaurusConcept(), ConceptStatusEnum.CANDIDATE).get(0) instanceof Object);
		// pojo Object
	}

	@Test
	public void getAssociatedConcepts() throws org.hibernate.HibernateException, org.hibernate.UnknownProfileException, javax.naming.NamingException {
		AssociativeRelationshipDAO associativeRelationshipDAO =
			 new AssociativeRelationshipDAO();
		List list = new ArrayList();
		list.add(new Object());
		...
		assertTrue(associativeRelationshipDAO.getAssociatedConcepts(new ThesaurusConcept()).get(0) instanceof Object);
		// pojo Object
	}

	@Test
	public void getAssociationsForConcept() throws org.hibernate.HibernateException, org.hibernate.UnknownProfileException, javax.naming.NamingException, java.text.ParseException {
	...
	@Test
	public void getAssociativeRelationship() throws org.hibernate.HibernateException, org.hibernate.UnknownProfileException, javax.naming.NamingException {
		...
		ThesaurusConcept conceptLeft = mock(ThesaurusConcept.class);
		...
		AssociativeRelationship.Id identifier6 = new AssociativeRelationship.Id();
		associativeRelationship.setIdentifier(identifier6);
		...
		AssociativeRelationship result =
			 associativeRelationshipDAO.getAssociativeRelationship("1234", "1234");
	...
	@Test
	public void getAssociativeRelationshipId1IsArReturnsNull() throws org.hibernate.HibernateException, org.hibernate.UnknownProfileException, javax.naming.NamingException {
		AssociativeRelationshipDAO associativeRelationshipDAO =
			 new AssociativeRelationshipDAO();
		Criteria criteria1 = mock(Criteria.class);
		when(criteria1.list())
