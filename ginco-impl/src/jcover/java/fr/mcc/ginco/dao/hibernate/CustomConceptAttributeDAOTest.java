...
public class CustomConceptAttributeDAOTest {
	...
	@Test
	public void getAttributesByEntity() throws org.hibernate.HibernateException, org.hibernate.UnknownProfileException, javax.naming.NamingException, java.text.ParseException {
	...
	@Test
	public void getAttributeByType() throws org.hibernate.HibernateException, org.hibernate.UnknownProfileException, javax.naming.NamingException {
		...
		CustomConceptAttribute result =
			 customConceptAttributeDAO.getAttributeByType(new ThesaurusConcept(), new GenericCustomAttributeType());
	...
	@Test
	public void getAttributeByTypeReturnsNull() throws org.hibernate.HibernateException, org.hibernate.UnknownProfileException, javax.naming.NamingException {
		CustomConceptAttributeDAO customConceptAttributeDAO =
			 new CustomConceptAttributeDAO();
		Criteria criteria1 = mock(Criteria.class);
		when(criteria1.list())
