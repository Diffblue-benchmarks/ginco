...
public class GincoBranchExportServiceImplTest {
	...
	@Test
	public void getBranchExportReturnsFoo() throws fr.mcc.ginco.exceptions.TechnicalException {
		List<ThesaurusTerm> list2 = new ArrayList<ThesaurusTerm>();
		list2.add(new ThesaurusTerm());
		...
		assertEquals("foo", service.getBranchExport(conceptBranchToExport));
	}
}
