...
public class GincoExportServiceUtilImplTest {
	...
	public void serializeBranchToXmlWithJaxb() throws java.text.ParseException, fr.mcc.ginco.exceptions.TechnicalException {
		...
		assertTrue(Pattern.matches("\\<\\?xml version\\=\"1\\.0\" encoding\\=\"UTF\\-8\" standalone\\=\"yes\"\\?\\>\n\\<gincoExportedBranch\\>\n    \\<conceptAttributeTypes\\>\n        \\<code\\>DE\\</code\\>\n        \\<value\\>value\\</value\\>\n        \\<exportable\\>false\\</exportable\\>\n    \\</conceptAttributeTypes\\>\n    \\<conceptAttributes/\\>\n    \\<concepts\\>\n        \\<identifier\\>data\\</identifier\\>\n        \\<created\\>\\d{4}-\\d{1,2}-\\d{1,2}T00:00:00Z\\</created\\>\n        \\<modified\\>\\d{4}-\\d{1,2}-\\d{1,2}T00:00:00Z\\</modified\\>\n        \\<status\\>1\\</status\\>\n        \\<notation\\>DE\\</notation\\>\n        \\<topConcept\\>false\\</topConcept\\>\n    \\</concepts\\>\n    \\<termAttributeTypes\\>\n        \\<code\\>DE\\</code\\>\n        \\<value\\>value\\</value\\>\n    \\</termAttributeTypes\\>\n    \\<termAttributes/\\>\n    \\<terms\\>\n        \\<identifier\\>data\\</identifier\\>\n        \\<lexicalValue\\>value\\</lexicalValue\\>\n        \\<created\\>\\d{4}-\\d{1,2}-\\d{1,2}T00:00:00Z\\</created\\>\n        \\<modified\\>\\d{4}-\\d{1,2}-\\d{1,2}T00:00:00Z\\</modified\\>\n        \\<source\\>foo\\</source\\>\n        \\<prefered\\>false\\</prefered\\>\n        \\<hidden\\>false\\</hidden\\>\n        \\<status\\>1\\</status\\>\n        \\<role\\>\n            \\<defaultRole\\>false\\</defaultRole\\>\n        \\</role\\>\n        \\<concept/\\>\n        \\<language\\>\n            \\<principalLanguage\\>false\\</principalLanguage\\>\n            \\<topLanguage\\>false\\</topLanguage\\>\n        \\</language\\>\n    \\</terms\\>\n    \\<alignments/\\>\n    \\<conceptNotes/\\>\n    \\<hierarchicalRelationship/\\>\n    \\<rootConcept\\>\n        \\<identifier\\>data\\</identifier\\>\n        \\<created\\>\\d{4}-\\d{1,2}-\\d{1,2}T00:00:00Z\\</created\\>\n        \\<modified\\>\\d{4}-\\d{1,2}-\\d{1,2}T\\d{1,2}:\\d{2}:\\d{2}Z\\</modified\\>\n        \\<status\\>1\\</status\\>\n        \\<notation\\>DE\\</notation\\>\n        \\<topConcept\\>false\\</topConcept\\>\n    \\</rootConcept\\>\n    \\<termNotes/\\>\n\\</gincoExportedBranch\\>\n", service.serializeBranchToXmlWithJaxb(branchToExport)));
	}
}
