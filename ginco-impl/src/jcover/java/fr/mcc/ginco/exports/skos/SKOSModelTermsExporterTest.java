...
public class SKOSModelTermsExporterTest {
	...
	@Test
	public void exportConceptNotPreferredTerm1() {
		ThesaurusTerm term = new ThesaurusTerm();
		term.setLanguage(new Language());
		term.setSource("foo");
		term.setStatus(1);
	...
	@Test
	public void exportConceptNotPreferredTerm2() {
		ThesaurusTerm term = new ThesaurusTerm();
		term.setLanguage(new Language());
		term.setStatus(1);
		Model model1 = mock(Model.class);
	...
	@Test
	public void exportConceptNotPreferredTermHiddenIsTrue() {
		ThesaurusTerm term = new ThesaurusTerm();
		term.setLanguage(new Language());
		term.setSource("foo");
		term.setStatus(1);
		...
		when(conceptResource.addProperty(Mockito.<com.hp.hpl.jena.rdf.model.Property>any(), Mockito.<com.hp.hpl.jena.rdf.model.RDFNode>any()))
			.thenReturn(resource2);
		assertSame(model6, service.exportConceptNotPreferredTerm(term, model6, conceptResource, true));
	}
}
