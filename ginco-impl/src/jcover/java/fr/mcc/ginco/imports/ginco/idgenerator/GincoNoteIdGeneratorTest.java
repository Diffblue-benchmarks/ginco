...
public class GincoNoteIdGeneratorTest {
	...
	@Test
	public void getNotesWithNewIds() {
		...
		JaxbList<Note> jaxbList = new JaxbList<Note>();
		notes.put("", jaxbList);
		assertSame(jaxbList, service.getNotesWithNewIds(notes, new HashMap<String, String>()).get("1234"));
	}
