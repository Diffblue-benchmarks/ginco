...
public class MistralStructuresBuilderTest {
	...
	@Test
	public void buildSynonymsStructureReturnsBar() throws java.text.ParseException {
		ArrayList<ThesaurusTerm> thesaurusTermList = new ArrayList<ThesaurusTerm>();
		ThesaurusTerm thesaurusTerm1 = new ThesaurusTerm();
		...
		thesaurus5.setType(new ThesaurusType());
		thesaurus5.setVersions(new HashSet<ThesaurusVersionHistory>());
		thesaurusConcept.setThesaurus(thesaurus5);
		thesaurusConcept.setTopConcept(false);
		conceptsAtRevision.add(thesaurusConcept);
		assertEquals(Arrays.asList("bar"), service.buildSynonymsStructure(conceptsAtRevision, 1, "mpeg").get("value"));
	}
