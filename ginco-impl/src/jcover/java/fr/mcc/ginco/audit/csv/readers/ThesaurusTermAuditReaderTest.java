...
public class ThesaurusTermAuditReaderTest {
	...
	@Test
	public void getTermAddedReturnsEmpty() throws org.hibernate.envers.exception.AuditException, javax.persistence.NonUniqueResultException, javax.persistence.NoResultException, java.text.ParseException {
		...
		assertTrue((service.getTermAdded(thesaurus, new SimpleDateFormat("yyyy-MM-dd").parse("2010-12-31"))).isEmpty());
	}

	@Test
	public void getTermRoleChangedReturnsEmpty() throws org.hibernate.envers.exception.AuditException, javax.persistence.NonUniqueResultException, javax.persistence.NoResultException, java.text.ParseException {
		AuditQuery auditQuery = mock(AuditQuery.class);
		when(auditQuery.getResultList())
			.thenReturn(new ArrayList());
	...
	@Test
	public void getTermLexicalValueChangedReturnsEmpty() throws org.hibernate.envers.exception.AuditException, javax.persistence.NonUniqueResultException, javax.persistence.NoResultException, java.text.ParseException {
		AuditQuery auditQuery = mock(AuditQuery.class);
		when(auditQuery.getResultList())
			.thenReturn(new ArrayList());
		when(auditQueryBuilder.getPropertyChangedQueryOnUpdate(Mockito.<Thesaurus>any(), Mockito.<java.util.Date>any(), Mockito.<Class<?>>any(), Mockito.<String>any()))
