...
public class ThesaurusConceptAuditReaderTest {
	...
	@Test
	public void getConceptAddedReturnsEmpty() throws org.hibernate.envers.exception.AuditException, javax.persistence.NonUniqueResultException, javax.persistence.NoResultException, java.text.ParseException {
		...
		assertTrue((service.getConceptAdded(thesaurus, new SimpleDateFormat("yyyy-MM-dd").parse("2010-12-31"))).isEmpty());
	}

	@Test
	public void getConceptHierarchyChangedReturnsEmpty() throws org.hibernate.envers.exception.AuditException, javax.persistence.NonUniqueResultException, javax.persistence.NoResultException, java.text.ParseException {
		AuditQuery auditQuery = mock(AuditQuery.class);
		when(auditQuery.getResultList())
			.thenReturn(new ArrayList());
	...
	@Test
	public void getConceptStatusChangedReturnsEmpty() throws org.hibernate.envers.exception.AuditException, javax.persistence.NonUniqueResultException, javax.persistence.NoResultException, java.text.ParseException {
		AuditQuery auditQuery = mock(AuditQuery.class);
		when(auditQuery.getResultList())
			.thenReturn(new ArrayList());
		when(auditQueryBuilder.getPropertyChangedQueryOnUpdate(Mockito.<Thesaurus>any(), Mockito.<java.util.Date>any(), Mockito.<Class<?>>any(), Mockito.<String>any()))
