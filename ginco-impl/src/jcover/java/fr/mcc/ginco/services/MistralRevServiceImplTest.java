...
public class MistralRevServiceImplTest {
	...
	@Test
	public void getAllRevisionsTimestampIsOne() throws org.hibernate.HibernateException, org.hibernate.MappingException, org.hibernate.UnknownProfileException, javax.naming.NamingException, java.io.IOException {
		...
		assertTrue(service.getAllRevisions(1L, language).getPath().startsWith(System.getProperty("java.io.tmpdir")));
	}
}
