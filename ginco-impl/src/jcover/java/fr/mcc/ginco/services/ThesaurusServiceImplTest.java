...
public class ThesaurusServiceImplTest {
	...
	@Test
	public void destroyThesaurusReturnsNull() throws fr.mcc.ginco.exceptions.TechnicalException {
		assertNull(service.destroyThesaurus(new Thesaurus()));
	}
	...
	@Test
	public void getThesaurusByIdReturnsNull() throws fr.mcc.ginco.exceptions.TechnicalException {
		assertNull(service.getThesaurusById("1234"));
	}
