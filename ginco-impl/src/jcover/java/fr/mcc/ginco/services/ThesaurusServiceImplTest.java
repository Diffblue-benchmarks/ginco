...
public class ThesaurusServiceImplTest {
	...
	@Test
	public void archiveThesaurus() throws java.text.ParseException, fr.mcc.ginco.exceptions.TechnicalException {
		...
		// act
		Thesaurus result = service.archiveThesaurus(thesaurus2);
		...
		assertFalse(result.isDefaultTopConcept());
		assertFalse(result.isPolyHierarchical());
		assertTrue(thesaurus2.isArchived());
	}
